...
public class HostRobotInfoManager {
    ...
    private Map<HostRobotInfoKey, HostRobotInfo> hostRobotInfoKeyHostRobotInfoMap = new ConcurrentHashMap<>();
...
//        secondaryIndex = store.getSecondaryIndex(primaryIndex, HostRobotInfoKey.class, "hostRobotInfoKey");
    ...
    public HostRobotInfo getHostRobotInfo(HostRobotInfoKey hostRobotInfoKey, Transaction txn) {
        if(hostRobotInfoKeyHostRobotInfoMap.containsKey(hostRobotInfoKey)) {
            return hostRobotInfoKeyHostRobotInfoMap.get(hostRobotInfoKey);
        }
        return null;
...
//            hostRobotInfo.setId(primaryIdSequence.get(txn, 1));
        ...
        hostRobotInfoKeyHostRobotInfoMap.put(hostRobotInfo.getHostRobotInfoKey(), hostRobotInfo);
    ...
    public void deleteHostRobotInfo(HostRobotInfo hostRobotInfo) {
        hostRobotInfoKeyHostRobotInfoMap.remove(hostRobotInfo.getHostRobotInfoKey());
