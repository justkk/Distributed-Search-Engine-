...
public class Crawler implements CrawlMaster {
    ...
    public synchronized static Crawler getCrawler() {

        if(crawler_for_this_run == null) {
    ...
    public void initializeCleaner() {
        crawlerCleaner = new CrawlerCleaner(this, 1000);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        CrawlerTopology crawlerTopology = new CrawlerTopology(null);
        crawlerTopology.buildTopologyAndStart();
