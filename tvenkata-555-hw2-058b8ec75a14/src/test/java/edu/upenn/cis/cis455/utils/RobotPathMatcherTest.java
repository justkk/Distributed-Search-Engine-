...
public class RobotPathMatcherTest extends TestCase {


    private RobotPathMatcher robotPathMatcher = new RobotPathMatcher();
    ...
    public void test1() {
        ...
        URLInfo urlInfo = new URLInfo("http://www.google.com/imgress");
        RobotStructure robotStructure = new RobotStructure(data);

        Assert.assertTrue(robotPathMatcher.pathMatch(urlInfo, robotStructure, Arrays.asList("facebookexternalhit")).isMatch());
    ...
    public void test2() {
        ...
        URLInfo urlInfo = new URLInfo("http://www.google.com/intl/b/about/views/");
        RobotStructure robotStructure = new RobotStructure(data);

        Assert.assertFalse(robotPathMatcher.pathMatch(urlInfo, robotStructure, Arrays.asList("*")).isMatch());
